...
namespace xEngine.Plugin.HtmlParsing
{
    ...
    public class HtmlDocument : IXPathNavigable
    {
        ...
        internal Hashtable Lastnodes = new Hashtable();
        internal Hashtable Nodesid;
        internal Hashtable Openednodes;
        ...
        public string HtmlCode
        {
            ...
            {
                if (_htmlCode == null)
                    _htmlCode = DocumentNode.OuterHtml;
                return _htmlCode;
            }
            set { _htmlCode = value; }
        }
        ...
        public Encoding DetectEncoding(string path)
        {
            ...
            var sr = new StreamReader(path, OptionDefaultStreamEncoding);
        ...
        public HtmlNode GetElementbyId(string id)
        {
            ...
            return Nodesid[id.ToLower()] as HtmlNode;
        }
        ...
        internal HtmlNode GetXmlDeclaration()
        {
            ...
            foreach (var node in DocumentNode.Childnodes)
            {
        ...
        private void CloseCurrentNode()
        {
            ...
            var prev = (HtmlNode) Lastnodes[_currentnode.Name];
            if (prev == null)
            {
                ...
                else
                {
                    ...
                    if (HtmlNode.CanOverlapElement(_currentnode.Name))
                    {
                        ...
                        var closenode = CreateNode(HtmlNodeType.Text, _currentnode.Outerstartindex);
                        closenode.Outerlength = _currentnode.Outerlength;
                    ...
                    else
                    {
                        if (HtmlNode.IsEmptyElement(_currentnode.Name))
                        {
                            AddError(
                                ...
                                _currentnode._line, _currentnode.Lineposition,
                                _currentnode.Streamposition, _currentnode.OuterHtml,
            ...
            else
            {
                ...
                if (!error)
                {
                    Lastnodes[_currentnode.Name] = prev.Prevwithsamename;
        ...
        {
            return Text.Substring(_currentattribute.Namestartindex, _currentattribute.Namelength);
        }

        private string CurrentAttributeValue()
        {
            return Text.Substring(_currentattribute.Valuestartindex, _currentattribute.Valuelength);
        }

        private string CurrentNodeInner()
        {
            return Text.Substring(_currentnode.Innerstartindex, _currentnode.Innerlength);
        }
        ...
        {
            return Text.Substring(_currentnode.Outerstartindex, _currentnode.Outerlength);
        }
        ...
        {
            var resetter = (HtmlNode) Lastnodes[name];
            if (resetter == null)
                return null;
            if (resetter.Closed)
            {
        ...
        private void Parse()
        {
            ...
            _oldstate = _state;
            DocumentNode.Innerlength = Text.Length;
            DocumentNode.Outerlength = Text.Length;
        ...
        {
            _currentattribute.Namelength = index - _currentattribute.Namestartindex;
        ...
        private void PushAttributeNameStart(int index)
        {
            ...
            _currentattribute.Namestartindex = index;
            _currentattribute.Line = _line;
            _currentattribute.Lineposition = _lineposition;
        ...
        private void PushNodeStart(HtmlNodeType type, int index)
        {
            ...
            _currentnode.Lineposition = _lineposition;
            if (type == HtmlNodeType.Element)
            {
                _currentnode.Lineposition--;
            }
        ...
        private void ReadDocumentEncoding(HtmlNode node)
        {
            ...
            if (content != null)
            {
                var charset = NameValuePairList.GetNameValuePairsValue(content.Value, "charset");
                if (!string.IsNullOrEmpty(charset))
                {
                    ...
                    if (StreamEncoding != null)
                    {
                        if (DeclaredEncoding.WindowsCodePage != StreamEncoding.WindowsCodePage)
                        {
                            AddError(
