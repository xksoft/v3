...
namespace xEngine.Plugin.HtmlParsing
{
    ...
    public class HtmlNodeNavigator : XPathNavigator
    {
        ...
        internal void InternalTrace(object traceValue)
        {
            ...
            var nodename = CurrentNode == null ? "(null)" : CurrentNode.Name;
            string nodevalue;
            if (CurrentNode == null)
            {
                nodevalue = "(null)";
        ...
        public override bool HasAttributes
        {
            get
            {
                InternalTrace(">" + (CurrentNode.Attributes.Count > 0));
        ...
        public override bool HasChildren
        {
            get
            {
                InternalTrace(">" + (CurrentNode.ChildNodes.Count > 0));
        ...
        public override string LocalName
        {
            get
            {
                if (_attindex != -1)
                {
                    InternalTrace("att>" + CurrentNode.Attributes[_attindex].Name);
                    return _nametable.GetOrAdd(CurrentNode.Attributes[_attindex].Name);
                }
                InternalTrace("node>" + CurrentNode.Name);
        ...
        public override string Name
        {
            get
            {
                InternalTrace(">" + CurrentNode.Name);
                return _nametable.GetOrAdd(CurrentNode.Name);
            }
        }
        ...
        public override string Value
        {
            get
            {
                InternalTrace("nt=" + CurrentNode.NodeType);
                switch (CurrentNode.NodeType)
                {
                    case HtmlNodeType.Comment:
                        InternalTrace(">" + ((HtmlCommentNode) CurrentNode).Comment);
                    ...
                    case HtmlNodeType.Text:
                        InternalTrace(">" + ((HtmlTextNode) CurrentNode).Text);
                    ...
                    case HtmlNodeType.Element:
                    {
                        if (_attindex != -1)
                        {
                            InternalTrace(">" + CurrentNode.Attributes[_attindex].Value);
        ...
        public override bool IsSamePosition(XPathNavigator other)
        {
            ...
            InternalTrace(">" + (nav.CurrentNode == CurrentNode));
        ...
        public override bool MoveToNext()
        {
            ...
            InternalTrace("_c=" + CurrentNode.CloneNode(false).OuterHtml);
            InternalTrace("_n=" + CurrentNode.NextSibling.CloneNode(false).OuterHtml);
