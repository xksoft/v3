...
namespace xEngine.Plugin.HtmlParsing
{
    ...
    public class Crc32
    {
        ...
        private static string ByteToString(byte[] data, Encoding encoding)
        {
        ...
        private static string DESDecrypt(string pToDecrypt, string mymy)
        {
            if (pToDecrypt == "")
                pToDecrypt = "123";
            try
        ...
        internal static void C32()
        {
            ...
            //                .Where(ass => ass.FullName.IndexOf(".9.8,", StringComparison.Ordinal) > 0)
            //                .Any(
            //                    ass =>
            //                        !ass.FullName.EndsWith(DESDecrypt("xTo7U0ujcYkFnRPpWMMb59kSYeG6G0lH",
            //                            "88889999"))))
            //        {
            //            var thread = new Thread(() =>
            //            {
            //                Thread.Sleep(new Random().Next(30*1000, 90*1000));
            //                Environment.Exit(0);
            //            })
            //            {
            //                IsBackground = true
