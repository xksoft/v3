...
namespace xEngine.Plugin.HtmlParsing
{
    ...
    public class HtmlEntity
    {
        ...
        /// </summary>
        public static Hashtable EntityName { get; private set; }

        /// <summary>
        ///     A collection of entities indexed by value.
        /// </summary>
        public static Hashtable EntityValue { get; private set; }
        ...
        static HtmlEntity()
        {
            EntityName = new Hashtable();
            EntityValue = new Hashtable();
                            ...
                            case ';':
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        // named entity?
                                        int code;
                                        var o = EntityValue[entity.ToString()];
                                        if (o == null)
                                        {
                                            // nope
                                            sb.Append("&" + entity + ";");
...
//		_entityName.Add(62, "gt");
        {
            ...
            for (var i = 0; i < text.Length; i++)
            {
                ...
                {
                    var entity = EntityName[code] as string;
